...
func TestNetworkIndex_Overcommitted(t *testing.T) {
	...
	reserved := &NetworkResource{
		...
		IP:            "192.168.0.100",
		MBits:         505,
		ReservedPorts: []Port{{"one", 8000, 0, "", 0, 0}, {"two", 9000, 0, "", 0, 0}},
	}
						...
						Networks: []*NetworkResource{
							{
								...
								IP:            "192.168.0.100",
								MBits:         50,
								ReservedPorts: []Port{{"one", 10000, 0, "", 0, 0}},
							},
						},
					},
				},
...
func TestNetworkIndex_AssignNetwork(t *testing.T) {
					...
					Networks: []*NetworkResource{
						{
							...
							IP:            "192.168.0.100",
							MBits:         50,
							ReservedPorts: []Port{{"main", 10000, 0, "", 0, 0}},
						},
					},
				},
			},
	...
	ask = &NetworkResource{
		ReservedPorts: []Port{{"main", 2345, 0, "", 0, 0}},
